...
exports.countUserTestResultsByTestAndTheme = async (themeId, testId, userId) => {
    const existResult = await TestResults.findOne({theme_id: themeId, user_id: userId, test_id: testId})
    if(existResult != null)
        return existResult.points
    else 0
}